...
function preload() {
  ...
  game.load.json('atlasFramesRecord', 'assets/sprites/atlas/sprites.json');
  game.load.atlas('atlas', 'assets/sprites/atlas/sprites.png', 'assets/sprites/atlas/sprites.json');
  game.load.tilemap(
    'level',
...
function createEntities() {
  ...
  for (let entity of map.objects.entities) {
    ...
    if (entityName === 'coin') {
      ...
      boss = createBoss(entity.x, entity.y, entityProps)
    }
  }
